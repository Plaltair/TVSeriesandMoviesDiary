...
public class CustomAdapterTVSeries extends BaseAdapter implements Filterable {

    private Context context;
    private List<RowItemTVSeries> rowItems;
    private List<RowItemTVSeries> rowItems2;

    private FixSize fixSize = new FixSize();

    CustomAdapterTVSeries(Context context, List<RowItemTVSeries> rowItems) {
        ...
        Filter filter = new Filter() {
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                ...
                if (constraint.length() == 0) {
                    rowItems2 = (ArrayList<RowItemTVSeries>) results.values;
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                ArrayList<RowItemTVSeries> filteredList = new ArrayList<RowItemTVSeries>();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.list_item_tv_series, null);

            holder.imageView = (CircleImageView)convertView.findViewById(R.id.imageView);
            holder.img = (ImageView)convertView.findViewById(R.id.img);
            holder.title = (TextView)convertView.findViewById(R.id.title);
            holder.episodeToBeSeen = (TextView)convertView.findViewById(R.id.episodeToBeSeen);
        ...
        RowItemTVSeries row_pos = rowItems2 .get(position);
        ...
        Cursor cursor = database.rawQuery("SELECT image FROM [tv_series_" + row_pos.getTableName() + "] WHERE title = '" + row_pos.getTitle() + "'", null);
        cursor.moveToFirst();
        image = cursor.getString(0);
        cursor.close();
        database.close();

        File file = new File(context.getFilesDir() + File.separator + "Images" + File.separator + "TV Series" + File.separator + row_pos.getTableName() + " - " + row_pos.getTitle());
        ...
        holder.episodeToBeSeen.setText(row_pos.getEpisodeToBeSeen());
